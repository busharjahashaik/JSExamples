...
//let students=["Sneha","Siva","Naga"];
// students.unshift("Sai"); //Add at start
// console.log(students)
// students.push("Sree") //Add at end
// console.log(students)
// students.splice(2,1,"Geetha") //Replace at index 2
// console.log(students)
// students.pop("Geetha")
// console.log(students)
...
studentMap.set("101",{name:"Shaik",dept:"CSE"});
studentMap.set("102",{name:"Bushar",dept:"ECE"});
studentMap.set("103",{name:"Jaha",dept:"MECH"});
